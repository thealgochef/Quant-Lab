...
AXIS_GROUP_ASSIGNMENTS: Mapping[str, str] = MappingProxyType(
    {
        # Staleness
        "setup_timeout_1m_bars": "Staleness",
        ...
        # Parent Handling
        "parent_replacement_policy": "Parent Handling",
        "parent_retest_depth_policy": "Parent Handling",
        ...
        "htf_gap_invalidation_policy": "HTF Selection",
        "htf_direction_selection_policy": "HTF Selection",
        "opposing_min_gap_ticks": "Parent Handling",
        ...
        "entry_schedule_policy": "Session Policy",
        "entry_schedule_timezone": "Session Policy",
        "entry_schedule_windows": "Session Policy",
        "holding_policy": "Session Policy",
        "daily_close_timezone": "Session Policy",
        "daily_close_time": "Session Policy",
        "daily_close_buffer_minutes": "Session Policy",
