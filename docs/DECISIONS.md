...
## Reservation note (2026-08-18, updated 2026-08-29 — not rulings)

D-042/D-043 remain as landed — all inside `ifvg_prop_robust_config_search_v1`, per the approved final plan package. (D-041 landed with R3; the trader half of D-045 with R4 and its pipeline half with R5; the MBP-1 activation block with R5B as D-046; the KMeans regime half of D-044 with R6; the MBP-1 coverage-policy correction with R5B.1 as D-048; the regime-lane correction with R6.1 as D-047, above. The GMM/minibatch/spectral/Nyström implementations remain the post-V1 regime-expansion release.)
